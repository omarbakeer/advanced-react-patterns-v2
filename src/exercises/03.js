...
const ToggleConsumer = props => (
  <ToggleContext.Consumer {...props}>
    {contextVal => {
      if (!contextVal) {
        throw new Error('You went out of the provider scope')
      }
...
class Toggle extends React.Component {
  ...
  static On = ({children}) => (
    <ToggleConsumer>
      {contextVal => (contextVal.on ? children : null)}
    </ToggleConsumer>
  )
  static Off = ({children}) => (
    <ToggleConsumer>
      {contextVal => (contextVal.on ? null : children)}
    </ToggleConsumer>
  )
  static Button = ({...props}) => (
    <ToggleConsumer>
